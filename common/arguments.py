...
def get_common_args():
    ...
    parser.add_argument('--map', type=str, default='UAV_offload', help='the map of the game')
    parser.add_argument('--seed', type=int, default=123, help='random seed')
    parser.add_argument('--obs_all_health', type=bool, default=True, help='obs all health')
    parser.add_argument('--obs_own_health', type=bool, default=True, help='obs own health')
    ...
    parser.add_argument('--alg', type=str, default='FC+QMIX', help='the algorithm to train the agent')
...
def get_mixer_args(args):
    ...
    anneal_steps = 10000*20
    args.anneal_epsilon = (args.epsilon - args.min_epsilon) / anneal_steps
    args.epsilon_anneal_scale = 'step'

    # the number of the epoch to train the agent
    args.n_epoch =20000 # 10000 ############6000 #
